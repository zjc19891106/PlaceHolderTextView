...
@objcMembers class PlaceHolderTextView: UITextView {
...
//        }
    ...
    override func draw(_ rect: CGRect) {
        ...
        newRect.origin.x = 5
        newRect.origin.y = 7
        let size = self.placeHolder.sizeWithText(font: self.font ?? UIFont.systemFont(ofSize: 14), size: rect.size)
...
extension String {
    fileprivate func sizeWithText(font: UIFont, size: CGSize) -> CGSize {
